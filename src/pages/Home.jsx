            ...
            <div className="gdsc">
              <LightSpeed left>
                <h1
                  className={
                    darkMode
                      ? "banner_header banner_header_dark"
                      : "banner_header banner_header_light"
                  }
                >
                  GDSC DJSCE
                </h1>
              ...
              >
                <span
                  className={
                    darkMode
                      ? "banner_text banner_dark"
                      : "banner_text banner_light"
                  }
                >
                  GDSC DJSCE represents the Google Developer Student Club at the
                  college level and is affiliated with Dwarkadas J. Sanghvi
        ...
        <div className="about">
          ...
          <div className="content_box">
            ...
            >
              ...
              college interested in Google developer technologies. Students from
              all undergraduate or graduate programs with an interest in growing
              as a developer are welcome. GDSC DJSCE is the club made due to
              persistent efforts put by Soham Dave, a fourth-year student from
        ...
        <div className="vision">
          ...
          <div className="content_box">
            <div className="content" data-aos="fade-left" data-aos-delay="500">
              To create a space for students, ranging from novice developers who
              are just starting, to advanced developers who want to further
              their skills where they can learn and collaborate as they solve
              real-world problems and to foster the ability to give back to
              society with the help of technology. We also aspire to imbibe a
              sense of responsibility amongst students by making them understand
              the importance of collectively and effectively working in a team
            </div>
          </div>
          <h1
            className={
              darkMode ? "header header_dark_home" : "header header_light"
            }
            style={darkMode ? { color: "white" } : {}}
            data-aos="fade-left"
            data-offset="100"
