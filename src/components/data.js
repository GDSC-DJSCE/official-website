...
import hackniche from "../assets/images/hackniche.webp";
const data = [
  {
    id: 1,
    title: "HackNiche 2023",
    bgimage: `${hackniche}`,
    bannerimage: `${hackniche}`,
    date: "Feb 17-18, 2023",
    type: "session",
    summary: "An offline 24-hour hackathon to get your creativity going.",
    description: `✨GDSC x SYNAPSE ✨ are here with one of the most exciting and rewarding 24 hours hackathon, 📢HACKNICHE📢 Work with your team of 2-4 members to showcase you infinite creativity. Participate in a day full of ideation, innovation and education and code the Future with us!
...
`,
  ...
  },
  {
    ...
    description: `Now that Flutter festival is here,
      ...
      Funny you ask because we have just the right thing for you. ✨
  ...
  },
  {
    ...
    description: `Curiosity is a necessity when it comes to technology." 💡
      ...
      We at GDSC have got your backs. Let's satiate this curiosity by building some awesome Android App with Kotlin, in our Android Study Jam 🔥
  ...
  },
  {
    ...
    type: "session",
    summary: "Speaker Session / Tech Talk - Virtual",
    description: `Ever wondered what makes a user’s experience with an application so satisfying? UI/UX design is the key! 👾

      🖥️GDSC DJSCE🖥️ and ⚡DJCSI⚡ present 👾PixelHacks👾, a comprehensive workshop on UI/UX!
      
      Join us on our journey to learn UI/UX Design! ✨
      
      🗣️: Ruchita Parmar, UX Generalist
  ...
  },
  {
    ...
    type: "session",
    summary: "Speaker Session / Tech Talk - Virtual",
    description: `GDSC DJSCE organized an event on “Open Source 101” on 23rd October 2021 and was the first event of the sort by the inaugurated by the committee. It was an astounding success, several students from many different colleges and universities had tuned in sharp at 4pm in the afternoon to learn from the talented guest speaker for the event. 
