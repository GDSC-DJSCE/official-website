      ...
      >
        ...
        <div className={classes.footerdetails}>
          ...
          >
            <Typography
              className={classes.community}
              style={{ padding: "1vh", paddingLeft: "0" }}
            >
              Follow Us
            </Typography>
              ...
              <div style={{ width: "5.7vh", height: "5.7vh" }}>
                <a href="mailto:gdsc.djsce@gmail.com">
                  {darkMode ? (
                    ...
                    <img
                      src="https://img.icons8.com/ios-filled/48/000000/gmail-new.png"
                      alt=""
                    />
                  )}
                </a>
        ...
        <div
          className={darkMode ? classes.darkfooterBottom : classes.footerBottom}
        >
          <div style={{ fontSize: "2.0vh" }}>&copy; GDSC DJSCE 2023</div>
          <div>
            {/* <img src={arrow} alt="arrow" style={{position:"absolute" ,width:"5vh", height:"7vh" ,marginLeft:"1vh", marginTop:"-3vh" }}/> */}
          </div>
          <div style={{ fontSize: "2.2vh" }}>Made with ❤ by GDSC DJSCE</div>
        </div>
      </AppBar>
    </div>
  );
